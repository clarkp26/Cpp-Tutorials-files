...
/*int Decrement(const int &input, int subtractor){
...
/*the casting section of code end*/
    ...
    Substitutes *NonVirtualSubs = new Substitutes("Casillas","Kompany","Gundogan","Aguero","Delph");
    cout << NonVirtualBoys->NonVirtualExample() << endl;
    cout << NonVirtualSubs->NonVirtualExample() << endl;
    NonVirtualBoys->display();
    NonVirtualSubs->display();
    /*binding Non-virtual*/
   ...
   /* Manager x("Mourinho");
    ...
    //int sample =5;
   // cout << Decrement(sample,2) << endl;
    /*Constant parameter function*/

    /*class Template*/
	/*Reserves<string> q("Paredes");
    Reserves<int> p(7);
    cout<<p.ReturnReserve()<<endl;
    cout<<q.ReturnReserve()<<endl;*/
    /*class Template*/
    ...
    FootballTeam United("De Gea","Smalling","Herrera","Rooney");

    vector<FootballTeam*> v;
    v.push_back(&City);
    v.push_back(&Spurs);
    v.push_back(&United);
